...
const LiveHostProfile: React.FC = () => {
  ...
  const host = {
    ...
    handle: "@ahmed_tech_official",
    bio: "Hargeisa's premium source for authentic gadgets. Live every Tuesday for flash sales and tech reviews! ⚡️📱",
    followers: "12.4k",
    likes: "420k",
    hours: "184",
        ...
        <section className="text-center mb-8">
          ...
          <div className="flex gap-3 justify-center mb-8">
            <button 
              ...
              className={`h-14 px-10 rounded-[22px] font-black text-xs uppercase tracking-[0.2em] transition-all shadow-lg active:scale-95 ${
                isFollowing 
