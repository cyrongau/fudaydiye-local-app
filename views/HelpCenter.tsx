        ...
        <section className="bg-primary/5 rounded-[40px] p-8 border border-primary/20 text-center space-y-6 mb-10">
           ...
           <div className="grid grid-cols-1 gap-3">
              <button 
                ...
                className="h-16 bg-secondary text-primary rounded-2xl font-black text-sm uppercase tracking-[0.2em] flex items-center justify-center gap-3 active:scale-[0.98] transition-all shadow-xl"
              >
