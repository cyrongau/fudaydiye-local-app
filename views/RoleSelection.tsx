           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {roles.map((role) => (
                <button
                  ...
                  className={`group relative flex flex-col p-10 rounded-[48px] text-left transition-all duration-500 border-2 ${
                    selected === role.id 
                ...
                >
                  <div className="flex justify-between items-start mb-10">
                    <div className={`size-20 rounded-[28px] flex items-center justify-center transition-all shadow-inner ${
                      selected === role.id 
                  ...
                  <h3 className={`text-2xl font-black uppercase tracking-tight mb-3 transition-colors ${
                    selected === role.id ? 'text-white' : 'text-secondary dark:text-white'
                  }`}>
                    {role.label}
                  </h3>
                  <p className={`text-[13px] font-medium leading-relaxed transition-opacity ${
                    selected === role.id ? 'text-white/80' : 'text-gray-500 dark:text-gray-400'
                  }`}>
                    {role.desc}
                  </p>
