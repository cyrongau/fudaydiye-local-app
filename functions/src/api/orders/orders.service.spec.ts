...
describe('OrdersService', () => {
    ...
    describe('create', () => {
        it('should create an order successfully', async () => {
            ...
            const result = await service.create(mockCreateOrderDto as any, 'user_123');
        ...
        it('should throw BadRequestException if stock is insufficient', async () => {
            ...
            await expect(service.create(mockCreateOrderDto as any, 'user_123')).rejects.toThrow('Insufficient stock');
        });
    });
});
